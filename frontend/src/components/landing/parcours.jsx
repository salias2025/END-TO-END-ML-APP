  ...
  const phases = [
    {
      ...
      items: [
        ...
        "تقييم استمرارية الأداء في كل مادة عبر السنوات",
        "تتبع التقدم في الوقت الفعلي",
        "مطابقتك مع طلاب البكالوريا السابقين بناءً على ملفك الشخصي",
        "تحليل معمق لملفك الشخصي واستخراج المعالم المشتقة",
      ],
    },
    {
